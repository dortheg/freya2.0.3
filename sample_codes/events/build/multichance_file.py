...
plt.plot(first_second_data[:,0] + Sn_Pu241, first_second_data[:,1]/F*100, label="First chance")
plt.plot(first_second_data[:,0] + Sn_Pu241, first_second_data[:,2]/F*100, label="Second chance")
plt.plot(first_second_data[:,0] + Sn_Pu241, first_second_data[:,3]/F*100, label="Third chance")
