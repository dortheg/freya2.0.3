...
int main ()
{
   ...
   sprintf(nudistname, "testEngConsNudist.res");
   sprintf(specname, "testEngConsSpec.res");
   sprintf(specTotalname, "testEngConsSpecTotal.res");
   sprintf(Totalname, "testEngConsTotal.res");
