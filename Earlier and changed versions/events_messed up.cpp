...
//messed up 12.jan when trying to implement photofission
...
bool FREYA_event(FILE* fp, int Z, int A, int fissionindex, double ePart, 
   ...
   // treat photofission as if it were neutron-induced fission -> NO! Therefore, I've commented it out
   
   if (fissiontype==2){ isotope--;
     cout << "Isotope2: " << isotope  <<endl;
   }
   ...
   //cout << "freyaA: " << freyaA << endl;
   //cout << "freyaA2: " << freyaA << endl;
